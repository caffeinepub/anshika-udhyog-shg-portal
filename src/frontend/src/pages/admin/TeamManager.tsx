              ...
              <CardContent className="p-3 flex items-start gap-3">
                {m.photo ? (
                  <img
                    src={m.photo}
                    alt={m.name}
                    className="h-14 w-14 rounded-full object-cover border-2 border-amber-300 shrink-0"
                  />
                ) : (
                  <div
                    className="h-14 w-14 rounded-full flex items-center justify-center text-white font-bold text-xl border-2 border-amber-300 shrink-0"
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <span
                    className={`text-[10px] font-semibold px-1.5 py-0.5 rounded-full mt-1 inline-block ${m.active ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
                  >
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div>
              <Label className="text-xs">Short Message</Label>
              <Textarea
                value={form.shortMessage}
                onChange={(e) =>
                  setForm((p) => ({ ...p, shortMessage: e.target.value }))
                }
